...
double pick_test(size_t id, size_t n, size_t rounds) {
  ...
  case 21:
    return run_multiple(n,rounds,5*83,"mat vect mult", t_mat_vec_mult<size_t,double>);
  case 22:
    return run_multiple(n,rounds,68,"scatter int", t_scatter<uint>);
  case 23:
    return run_multiple(n,rounds,1,"histogram int", t_sparse_histogram<int>,"Gelts/sec");
  case 24:
    return run_multiple(n,rounds,1,"histogram int", t_sparse_histogram_acc<int>,"Gelts/sec");
  case 25:
    return run_multiple(n,rounds,1,"histogram int", t_sparse_histogram_acc_compact<int>,"Gelts/sec");
  case 26:
    return run_multiple(n,rounds,1,"histogram int", t_sparse_histogram_acc_compact_no_transpose<int>,"Gelts/sec");
