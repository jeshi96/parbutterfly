...
intT CountESortCE(CountESpace& cs, bipartiteCSR& GA, bool use_v, long num_wedges, long* butterflies, long max_wedges, long* wedge_idxs, uintE* eti, intT curr_idx=0) {
  ...
  //radix::blockIntegerSort<uintE>(wedges, num_wedges_f, UWFirst());
  //radix::blockIntegerSort<uintE>(wedges, num_wedges_f, UWSecond());
  intSort::iSort(wedges, num_wedges_f, 5,  UWFirst());
